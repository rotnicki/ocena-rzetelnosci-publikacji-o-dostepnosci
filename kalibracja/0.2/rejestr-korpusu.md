# Zamrożony korpus kalibracyjny 0.2

**Data ustalenia:** 31 sierpnia 2026 r.  
...
Kolejność ustalono rosnąco według SHA-256 z ciągu `ocena-0.2-kolejnosc-2026-08-21|` oraz kanonicznego URL.

| Kolejność | ID | Kategoria | Publikacja | Autor / miejsce | SHA-256 kolejności |
|---:|---|---|---|---|---|
| 1 | C04 | komercyjna lub praktyczna | [Europejski Akt o Dostępności – jak dostosować sklep internetowy do jego wymogów?](https://www.ibif.pl/blog/sklepy-internetowe/europejski-akt-o-dostepnosci-jak-dostosowac-sklep-internetowy-do-jego-wymogow) | Magdalena Krawczyńska, IBIF | `0daabec16bd4f95c1ad0552a081d2e9fe0d5dac58a804abe175eb8cd7221615b` |
...
| Kategoria | Kandydat rezerwowy |
|---|---|
| techniczna lub normatywna | T02 — iFirma |
| prawna lub zgodnościowa | L04 — PARP |
| komercyjna lub praktyczna | C05 — Emerald Media |
| badania lub doświadczenia użytkowników | U03 — Imset |
| popularna, opiniotwórcza, instytucjonalna lub mieszana | P03 — NowyMarketing |

## Kontrola różnorodności

Wybrany korpus obejmuje osiem różnych domen i osiem różnych autorów lub zespołów. Zawiera publikację instytucji publicznej lub publicznego środowiska akademickiego, publikację badawczą oraz co najmniej dwie publikacje podmiotów komercyjnych. Kategorie i tematy nie były ustalane na podstawie oczekiwanego wyniku.
